...
public class SwerveDrive extends SubsystemBase {
  ...
  public void resetPose(Pose2d pose) {
    odometer.resetPosition(getRotation2d(), new SwerveModulePosition[] { frModule.getPosition(), flModule.getPosition(),
        brModule.getPosition(), blModule.getPosition() }, pose);
  }

  public ChassisSpeeds getCurrentSpeeds() {
    return DriveConstants.DriveKinematics.toChassisSpeeds(frModule.getState(), flModule.getState(), brModule.getState(),
        blModule.getState());
  }
